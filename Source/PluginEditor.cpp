...
juce::String makeInitJS(KikAudioProcessor& ap)
{
    ...
    obj->setProperty("fine", getVal("fine"));
    obj->setProperty("pitchDecay", getVal("pitchDecay"));
    obj->setProperty("pitchCurve", getVal("pitchCurve"));
    ...
    obj->setProperty("driveType", (double)*ap.apvts.getRawParameterValue("driveType"));
    ...
    obj->setProperty("enhancer", getVal("enhancer"));
     obj->setProperty("limiter", (bool)*ap.apvts.getRawParameterValue("limiter"));
     obj->setProperty("bpm", getVal("bpm"));
     obj->setProperty("loopEnabled", (bool)*ap.apvts.getRawParameterValue("loopEnabled"));
     obj->setProperty("oversample", getVal("oversample"));
