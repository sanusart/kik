...
juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
{
    ...
    params.push_back (std::make_unique<juce::AudioParameterFloat> (juce::ParameterID {"fine", 1}, "Fine Tune", -100.0f, 100.0f, 0.0f));
    params.push_back (std::make_unique<juce::AudioParameterFloat> (juce::ParameterID {"pitchDecay", 1}, "Pitch Decay", 0.05f, 0.5f, 0.23f));
    params.push_back (std::make_unique<juce::AudioParameterFloat> (juce::ParameterID {"pitchCurve", 1}, "Pitch Curve", 0.0f, 1.0f, 0.5f));
    ...
    params.push_back (std::make_unique<juce::AudioParameterChoice> (juce::ParameterID {"driveType", 1}, "Drive Type", juce::StringArray {"Soft", "Hard", "Asymmetric"}, 0));
    ...
    params.push_back (std::make_unique<juce::AudioParameterBool> (juce::ParameterID {"limiter", 1}, "Limiter", false));
...
namespace FactoryPresetData
{
    ...
    struct Entry
    {
        const char* name;
        int waveform;
        float pitch, fine, pitchDecay, pitchCurve, ampAttack, ampDecay, ampSustain, ampRelease;
        float drive, driveType, color, click, clickPitch, depth;
    ...
    constexpr Entry entries[] = {
        { "Default",
          0, 196.0f, 0.0f, 0.23f, 0.5f, 0.001f, 0.30f, 0.0f, 0.20f, 1.00f, 0.0f, 0.50f, 0.0f, 4000.0f, 0.50f, 35.0f, 20000.0f, 1.0f, 0.0f, false },
        { "Sub Layer",
          0, 47.0f, 0.0f, 0.07f, 0.5f, 0.002f, 0.58f, 0.0f, 0.55f, 0.92f, 0.0f, 0.10f, 0.06f, 1400.0f, 0.88f, 28.0f, 16500.0f, 1.0f, 0.0f, false },
        { "Club Kick",
          0, 55.0f, 0.0f, 0.17f, 0.5f, 0.001f, 0.38f, 0.0f, 0.30f, 1.14f, 0.0f, 0.22f, 0.30f, 3400.0f, 0.58f, 35.0f, 18500.0f, 1.0f, 0.0f, false },
        { "Tight Sidechain",
          0, 70.0f, 0.0f, 0.38f, 0.5f, 0.001f, 0.13f, 0.0f, 0.10f, 0.72f, 0.0f, 0.12f, 0.38f, 6200.0f, 0.22f, 48.0f, 13500.0f, 1.0f, 0.0f, false },
        { "Trap Long",
          0, 40.0f, 0.0f, 0.055f, 0.5f, 0.005f, 0.82f, 0.0f, 0.62f, 1.08f, 0.0f, 0.03f, 0.11f, 750.0f, 0.95f, 28.0f, 12000.0f, 1.0f, 0.0f, false },
        { "Punch & Click",
          1, 86.0f, 0.0f, 0.36f, 0.5f, 0.001f, 0.16f, 0.0f, 0.13f, 1.42f, 0.0f, 0.36f, 0.78f, 6000.0f, 0.20f, 38.0f, 17500.0f, 1.0f, 0.0f, false },
        { "Warm House",
          1, 53.0f, 0.0f, 0.15f, 0.5f, 0.0025f, 0.46f, 0.0f, 0.36f, 1.22f, 0.0f, 0.32f, 0.20f, 2700.0f, 0.52f, 32.0f, 16000.0f, 1.0f, 0.0f, false },
        { "Distorted Slam",
          3, 71.0f, 0.0f, 0.29f, 0.5f, 0.001f, 0.18f, 0.0f, 0.15f, 2.55f, 1.0f, 0.65f, 0.58f, 5400.0f, 0.26f, 42.0f, 15000.0f, 1.0f, 0.0f, false },
        { "DnB Roller",
          1, 79.0f, 0.0f, 0.25f, 0.5f, 0.001f, 0.39f, 0.0f, 0.38f, 1.68f, 0.0f, 0.42f, 0.50f, 4450.0f, 0.50f, 38.0f, 17000.0f, 1.0f, 0.0f, false },
        { "Lo-Fi Thick",
          0, 64.0f, 0.0f, 0.14f, 0.5f, 0.005f, 0.42f, 0.0f, 0.44f, 1.42f, 0.0f, 0.52f, 0.33f, 1750.0f, 0.45f, 55.0f, 7500.0f, 1.0f, 0.0f, false },
        { "Big Room",
          0, 51.0f, 0.0f, 0.19f, 0.5f, 0.001f, 0.54f, 0.0f, 0.85f, 1.78f, 0.0f, 0.40f, 0.46f, 3800.0f, 0.64f, 30.0f, 14500.0f, 1.0f, 0.0f, false },
        { "Rock Punch",
          1, 82.0f, 0.0f, 0.22f, 0.5f, 0.003f, 0.33f, 0.0f, 0.26f, 1.52f, 0.0f, 0.34f, 0.45f, 3100.0f, 0.36f, 40.0f, 15500.0f, 1.0f, 0.0f, false },
        { "Mix Ready",
          0, 92.0f, 0.0f, 0.22f, 0.5f, 0.001f, 0.28f, 0.0f, 0.21f, 1.10f, 0.0f, 0.35f, 0.28f, 3900.0f, 0.42f, 38.0f, 17500.0f, 1.0f, 0.0f, false },
    };
...
void KikAudioProcessor::loadPreset(int index)
{
    ...
    setPhysicalParam (apvts, "fine", juce::jlimit (-100.0f, 100.0f, P.fine));
    setPhysicalParam (apvts, "pitchDecay", juce::jlimit (0.05f, 0.5f, P.pitchDecay));
    setPhysicalParam (apvts, "pitchCurve", juce::jlimit (0.0f, 1.0f, P.pitchCurve));
    ...
    if (auto* p = apvts.getParameter ("driveType"))
        p->setValueNotifyingHost (P.driveType / 2.0f);
    ...
    setPhysicalParam (apvts, "gain", juce::jlimit (0.0f, 1.5f, P.gain));
    setPhysicalParam (apvts, "enhancer", juce::jlimit (0.0f, 1.0f, P.enhancer));
    if (auto* p = apvts.getParameter ("limiter"))
        p->setValueNotifyingHost (P.limiter ? 1.0f : 0.0f);
